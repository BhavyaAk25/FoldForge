...
export const createPullTabPopUpFlowerShowcase =
  (): OfflineFabricationShowcase => {
    ...
    const intent: FabricationIntentV1 = {
      ...
      visualDescription:
        "A square card base beneath a twelve-point faceted flower crown and guided pull-tab feature.",
      behavior: "slide",
      ...
      modules: [
        {
          ...
          registryVersion: 1,
          kind: "panel_layout",
          label: "Base and faceted flower crown",
          parameters: [],
          ports: [
            {
      ...
      blueprint: {
        panels: [
          ...
          },
          {
            ...
            label: "Faceted flower petal crown",
            role: "output",
            widthMm: 70,
            heightMm: 70,
            contour: {
